...
export function FriendsList() {
  ...
  const handleSendRequest = async () => {
    ...
    try {
      await sendRequest.mutateAsync({ handle: friendHandle });
  ...
  const getInitials = (displayName: string | null, handle: string | null) => {
    if (displayName) {
      return displayName
        .split(' ')
        .map((n) => n[0])
          ...
          <Dialog open={addFriendOpen} onOpenChange={setAddFriendOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  Enter the handle of the person you'd like to add as a friend
                </DialogDescription>
              </DialogHeader>
                ...
                <div className="grid gap-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-7"
                      value={friendHandle}
                      onChange={(e) => setFriendHandle(e.target.value.toLowerCase())}
                      onKeyDown={(e) => {
                        if (e.key === 'Enter') {
                          handleSendRequest();
                        }
