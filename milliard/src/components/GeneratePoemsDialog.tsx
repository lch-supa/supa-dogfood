  ...
  const handleGenerate = async () => {
    if (!theme.trim()) {
      toast({
        ...
        description: "Please enter a theme for your poem set.",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      ...
      toast({
        title: "Draft created!",
        description: `"${result.title}" saved to My Sets. Visit My Sets to publish it.`,
      });
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const result = await saveManualSet.mutateAsync({
        input: {
          title: title,
          theme: title, // Use title as theme
          poems: poems,
        },
        status: 'draft',
        id: currentDraftId,
          ...
          <TabsContent value="auto" className="space-y-4">
            <div className="space-y-4 py-4">
              <div className="space-y-2">
                ...
                <Input
                  id="theme"
                  placeholder="e.g., Love and Loss, Nature's Seasons, Urban Life..."
                  value={theme}
              ...
              <div className="text-sm text-muted-foreground bg-muted p-3 rounded">
                <strong>Note:</strong> Generation takes 30-60 seconds. Claude will create a set of 10 Shakespearean sonnets based on the title and any additional information you provide. The final syllables of each corresponding line of each generated sonnet will possess compatible rhyme sounds.
              </div>
            </div>
            ...
            <DialogFooter>
              ...
              <Button
                ...
                disabled={generatePoems.isPending || !theme.trim()}
              >
